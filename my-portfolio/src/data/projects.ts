...
export const projects: Project[] = [
  {
    ...
    category: 'all',
    title: 'DTech',
    techStack: ['React', 'TypeScript', 'Vite', 'Tailwind CSS', 'Python', 'YOLO model detection'],
    summary: 'Developed an industrial PPE detection system that integrates fine-tuned AI models with a custom-built web application to support real-time safety monitoring through on-site cameras.',
    paperImages: ['/project/DTech/dtech-1.jpeg', '/project/DTech/dtech-2.png', '/project/DTech/dtech-4.jpeg'],
    projectUrl: 'https://github.com/nicky-wrc/ppe-detection-system.git',
    sampleImages: [
      '/project/DTech/dtech-1.jpeg',
      '/project/DTech/dtech-2-1.jpeg' , 
      '/project/DTech/dtech-3.jpeg',
      '/project/DTech/dtech-4.jpeg',
      '/project/DTech/dtech-5.jpeg',
      '/project/DTech/dtech-6.jpeg',
      '/project/DTech/dtech-7.jpg',
    ]
  },
  {
    id: 'SmartMotoService-featured',
    category: 'all',
    title: 'RevUp',
    ...
    sampleImages: [
      '/project/Revup/car-cover.jpeg',
      '/project/Revup/car-1.png',
      '/project/Revup/car-2.png',
      '/project/Revup/car-3.png',
      '/project/Revup/car-4.png',
      '/project/Revup/car-5.png',
      '/project/Revup/car-6.png',
      '/project/Revup/car-7.png',
      '/project/Revup/car-8.png',
      '/project/Revup/car-9.png',
      '/project/Revup/car-10.png',
      '/project/Revup/car-11.png',
      '/project/Revup/car-12.png',
      '/project/Revup/car-13.png',
      '/project/Revup/car-14.png',
      '/project/Revup/car-15.png',
      '/project/Revup/car-16.png',
      '/project/Revup/car-17.png',
      '/project/Revup/car-18.png',
      '/project/Revup/car-19.png',
      '/project/Revup/car-20.png',
      '/project/Revup/car-21.png',
      '/project/Revup/car-22.png',
      '/project/Revup/car-23.png',
      '/project/Revup/car-24.png',
      '/project/Revup/car-25.png',
      '/project/Revup/car-26.png',
      '/project/Revup/car-27.png',
      '/project/Revup/car-28.png',
      '/project/Revup/car-29.png',
      '/project/Revup/car-30.png',
      '/project/Revup/car-31.png',
      '/project/Revup/car-32.png',
      '/project/Revup/car-33.png',
      '/project/Revup/car-34.png',
    ]
  },
    {
    id: 'Ride-featured',
